...
export default function Navbar() {
  ...
  // ✅ Define sections based on login state inside the component
        ...
        <div className="flex gap-4">
          {sections.map((section) => (
            <motion.button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-xl transition-all duration-200 ${activeSection === section.id
                ? "bg-white text-indigo-600 font-semibold shadow dark:bg-white dark:text-indigo-700"
                : "hover:bg-white/20 dark:hover:bg-white/10 text-white dark:text-white"
                }`}
            >
              {section.icon}
